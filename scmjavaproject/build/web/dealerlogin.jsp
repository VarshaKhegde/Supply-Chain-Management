<%-- 
    ...
    Created on : 23 Jun, 2024, 3:08:54 PM
    Author     : HP
--%>
...
<!--                  <img src="../../assets/images/logo.svg" alt="logo">-->
                ...
                <form class="pt-3" action="dealerlogindb" method="POST">
...
<!--                  <div class="mb-2 d-grid gap-2">
                  ...
                  <div class="text-center mt-4 fw-light"> Don't have an account? <a href="dealeregister.jsp" class="text-primary"><br>Create</a>
                  </div>
                </form>
              </div>
            </div>
